...
def adaptive_instance_normalization(content_feat, style_feat, mask=None):
...
class StableDiffusionBrushNetAdaINInversionNoMaskPipeline(
    DiffusionPipeline,
    ...
    def __call__(
        ...
        image_nomask: PipelineImageInput = None,
        ...
        **kwargs,
        ...
        if isinstance(brushnet, BrushNetModel):
            ...
            image_nomask = self.prepare_image(
                image=image_nomask,
                width=width,
                height=height,
                batch_size=batch_size * num_images_per_prompt,
        ...
        latents = adaptive_instance_normalization(content_feat=latents, style_feat=inversion_latent)

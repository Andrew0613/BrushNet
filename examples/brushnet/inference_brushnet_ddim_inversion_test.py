from diffusers import StableDiffusionBrushNetDDIMInversionPipeline, BrushNetModel, UniPCMultistepScheduler, AutoencoderKL, DDIMScheduler
...
output_dir = "output/brushnet_400k/desciption"
if not os.path.exists(output_dir):
    os.makedirs(output_dir)
base_model_path = "pretrained/sd_checkpoints/Realistic_Vision_V6.0_B1_noVAE"
# brushnet_path = "pretrained/brushnet"
brushnet_path = "runs/logs/brushnet_segmentationmask/checkpoint-400000/brushnet"
...
pipe = StableDiffusionBrushNetDDIMInversionPipeline.from_pretrained(
    base_model_path, brushnet=brushnet, vae=vae, scheduler = noise_scheduler, torch_dtype=torch.float16, low_cpu_mem_usage=False
)

...
from diffusers import (
    ...
    BrushNetModel,
    DDPMScheduler,
    StableDiffusionBrushNetDDIMInversionPipeline,
    UNet2DConditionModel,
    UNet2DConditionAdaINModel,
...
def log_validation(
    ...
    pipeline = StableDiffusionBrushNetDDIMInversionPipeline.from_pretrained(
...
def main(args):
    ...
    unet = UNet2DConditionAdaINModel.from_pretrained(
